...
const ALARM_RULES = [
  ...
  {
    key: 'fdsHighScore5', level: 'WATCH',
    label: 'FDS 스코어 주의 구간',
    detail: '카드사 FDS 스코어가 주의 구간(불량률 5% 이상)입니다.',
    // BC: 가맹점FDS스코어고득점_불량률5%이상(FA00001)
    // [2026-09-16 추가] 5%(주의) → 10%(보류) 2단 사다리. 5% 는 10% 를 포함하는 넓은 구간이라
    //   한 단계 낮춰 WATCH — 판정은 바꾸지 않고 화면에 사유만 남긴다. 10%(fdsHighScore10)는 종전대로 HOLD.
